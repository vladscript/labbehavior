...
% Figure
% File
function animatedistance_explorations_clean(FD,ta,HorrtDistance,VertDistance,leftLim,rightLim,topLim,bottomLim,Xnose,Ynose,fps,tnose,interA,interB,savebool)
%% setup 
% Nframes=numel(tnose);
...
%         fprintf('\n\nError!!!\n\n')
% end
ratiosax=[HorrtDistance/VertDistance 1 1];
%% fixing polygons
% pgonAfix=pgonA;
% pgonBfix=pgonB;
% 
